...
- Completed: Xcode Cloud Builds 3, 4 and 5 uploaded and processed as version 1.0, VALID / APP_STORE_ELIGIBLE. Build 6 (source fb1c2b3) also completed Build and Archive with zero errors/warnings, processed VALID / APP_STORE_ELIGIBLE, and is now attached to version 1.0. Its build ID is f69e9707-cf79-4e7d-89f0-3de5699cbb3c. Upload success does not satisfy the implementation and acceptance requirements above. Subsequent wallet activity-label, model-availability and pricing-copy changes need a new processed native build.
